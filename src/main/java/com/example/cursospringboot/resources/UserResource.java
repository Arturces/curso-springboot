...
public class UserResource {
    ...
    @DeleteMapping(value = "/{id}")//annotation para deletar
    public ResponseEntity<Void> delete(@PathVariable Long id){ //é void pois nao retorna nenhum corpo, simplismente deleta
        service.delete(id);
